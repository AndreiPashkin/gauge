...
struct Span {
    ...
    Span(const TraceType &trace, const Frame &frame) :
        symbolic_name{frame.symbolic_name},
        file_name{frame.file_name},
        line_number{frame.line_number},
        is_coroutine{frame.is_coroutine},
        is_generator{frame.is_generator},
        monotonic_clock_timestamp{
            trace.monotonic_clock_timestamp
        },
...
class CallTrace {
    ...
    std::chrono::steady_clock::time_point
        start_monotonic_clock_timestamp = {};
    std::chrono::steady_clock::time_point
        end_monotonic_clock_timestamp = {};
